-- 1. Creating a new database called Human_resource 
CREATE DATABASE Human_resource;

-- 2. Making the database active so that I can create a table within. 
USE Human_resource;

-- 3. Creating a table called BioData in the database using MySQL 
...
-- 4. Creating a table called JobDetails in the database using MySQL
...
-- 5. Creating a table called RenumerationAndAllowanceDetails in the database using MySQL
...
-- 6. Creating a table called PerformanceDetails in the database using MySQL
...
-- 6. Adding a new column called  MidTermReviewStatus in the table - PerformanceDetails in the database using MySQL after  EmployeeID column
...
-- 7. Deleting a column called  MidTermReviewStatus from a table - PerformanceDetails in the database using MySQL.

ALTER TABLE PerformanceDetails
DROP COLUMN MidTermReviewStatus;

-- 8. Deleting an entire table called PerformanceDetails
